...
p <- plot_grid(ggmatrix_gtable(p1), ggmatrix_gtable(p2), ggmatrix_gtable(p3), 
               ggmatrix_gtable(p4),  ncol = 2)
ggsave(file="./man/figures/articles/agree_items_correlations_comparison.svg", 
...
ggsave(file="./man/figures/articles/agreeableness_grouped_boxplot.svg", 
       plot=p, width=10, height=4.8)
```
