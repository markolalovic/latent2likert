...
---
<!--
   TODO: change <img src="../../reference/ ... /> to <img src="../reference/ ... /> 
-->
...
Users can specify latent variables by providing means, standard deviations, and optionally, skewness and correlations. The generated dataset represents responses to Likert scale questions, useful for various purposes such as validating theoretical findings obtained through techniques like Factor Analysis and Structural Equation Modeling. The package also allows for the estimation of parameters from existing survey data to replicate it more accurately.
