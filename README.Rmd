...
<figure>
    ...
    <figcaption>Overview of inputs and outputs.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>Transformation of latent variables to Likert response variables.</figcaption>
</figure>

Note that, depending on the value of the skewness parameter, the normal latent distribution is used if skew = 0, otherwise the skew normal distribution is used. The value of skewness is limited to slightly less than the interval (-1, 1):
